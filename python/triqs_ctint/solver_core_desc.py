...
c.add_member(c_name = "use_auxiliary_spin_flip",
             c_type = "bool",
             initializer = """ false """,
             doc = r"""Use auxiliary spin-flip insertion (requires n_s = 2)""")
...
c.add_member(c_name = "rethrow_exception",
             c_type = "bool",
             initializer = """ true """,
             doc = r"""Catch exceptions on nodes and rethrow on rank 0""")
